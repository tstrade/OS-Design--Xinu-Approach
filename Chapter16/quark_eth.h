...
#define INTEL_ETH_QUARK_PCI_DID 0x0937
#define INTEL_ETH_QUARK_PCI_VID 0x8086
...
struct eth_q_tx_desc {
  ...
  uint64  buffer1;        /* Address of buffer 1  */
  uint64  buffer2;        /* Address of buffer 2  */
};
...
/* Not listed - placeholder to fix syntax error in other files */
#define QUARK_MAC1_ID 0x0000ABCD
